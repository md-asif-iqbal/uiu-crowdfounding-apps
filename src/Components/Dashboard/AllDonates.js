...
const AllDonates = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:8000/alldonates')
            .then(res => res.json())
	...
	<div className="container flex flex-col items-center mx-auto -mt-20 mb-12 md:p-10 md:px-12">
	</div>
	<div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
        {
			...
			<div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-violet-400 text-gray-900">
				<p className="text-xl font-semibold leading-tight">${item.price}</p>
