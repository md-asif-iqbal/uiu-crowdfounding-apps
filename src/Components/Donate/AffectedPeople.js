      ...
      <div className="flex flex-col items-start w-full max-w-xl px-4 mx-auto lg:px-8 lg:max-w-screen-xl">
        <div className="mb-16 lg:my-20 lg:max-w-lg lg:pr-5">
          <div className="max-w-xl mb-6">
            ...
            Every year Bangladesh faces many natural disasters,like flood,strom & many sudden accidents & many people are affected.Overall risk of climate related impactare now vulnarable .Donate some money for them.
            </p>
          </div>
...
<div className="flex flex-col items-start w-full max-w-xl px-4 mx-auto lg:px-8 lg:max-w-screen-xl">
  <div className="mb-16 lg:my-20 lg:max-w-lg lg:pr-5">
    <div className="max-w-xl mb-6">
      ...
      <p className="text-center text-gray-700 md:text-lg">
      The need for winter clothing during winter — especially at the beginning of the season. Not only do regulars need items, but families often come to shelters seeking jackets, hats and gloves. Purchasing all of these items for each child can place a significant burden on families that are just getting by financially. If you’d like to donate clothing, thick socks, boots, coats, scarves and hats are some of the most sought-after items or some money. Don’t just limit what you bring to winter essentials. Below is a list of just some of the items that are needed for men, women, and children year round.
      </p>
    </div>
    <div className="flex flex-col items-center md:flex-row">
    {
...
<input type="checkbox" id="my-modal" className="modal-toggle" />
  <section id="login" class="p-4 bg-transparent flex flex-col justify-center min-h-screen max-w-md mx-auto modal"> 

    <div class="p-6 -mt-20 bg-sky-100 rounded relative">
    <label htmlFor="my-modal" className="btn btn-sm btn-circle absolute right-2 top-3">✕</label>
      ...
      <h1 class="tracking-wide text-3xl text-gray-900">Donate for people</h1>
      </div>
        <form id="login_form" onSubmit={handleSubmit(onSubmit)} action="api_login" method="POST"
        ...
        <div class="flex justify-between items-center mb-3">
          ...
          <div class="flex">
             <button type="button" onClick={decrease} class="bg-yellow-600 p-1.5 font-bold rounded">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M5 10a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z" clip-rule="evenodd" />
              </svg>
            </button>
            
            <input id="item_count" type="number"
            ...
            {...register("price", {
             ...
             onChange={handleInput} value={counterDinner}
            ...
            <button type="button" onClick={increase} class="bg-green-600 p-1.5 font-bold rounded">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
          ...
          focus:ring-1
          focus:ring-sky-500
          focus:invalid:border-red-500 focus:invalid:ring-red-500" type="text" name="name" placeholder="Enter your name" required/>
          ...
          focus:ring-1
          focus:ring-sky-500
          focus:invalid:border-red-500 focus:invalid:ring-red-500" type="text" name="email" placeholder="Noob@example.com" required/>
          ...
          focus:ring-1
          focus:ring-sky-500
          focus:invalid:border-red-500 focus:invalid:ring-red-500" name="details" placeholder="Write something"></textarea>
          <button class="px-4 py-1.5 rounded-md shadow-lg bg-gradient-to-r from-pink-600 to-red-600 font-medium text-gray-100 block transition duration-300" type="submit">
            ...
            <span id="login_default_state">Donate<span id="subtotal"> ${counterDinner}</span></span>
          </button>
        </form>
    </div>
  </section>
